...
// a marker line + a short human sentence + a fenced JSON metadata envelope with allow-listed keys
// only (no code, no diffs, no secrets — only a report_hash fingerprint).
//
 ...
 * @returns {string} the full comment body (marker line + sentence + fenced JSON)
 */
