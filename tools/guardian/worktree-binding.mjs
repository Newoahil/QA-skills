...
export function validateBinding(binding, { canonicalTargetPath, guardianRepoPath } = {}) {
  ...
  return { ok: true, binding: { ...binding, selected_runtime_input_paths: inputs.paths } };
}

export function makeStrictBinding({ canonicalTargetPath, guardianRepoPath, baseBranch, gitIdentity }) {
  return {
...
export function makeWorktreeBinding({ canonicalTargetPath, guardianRepoPath, baseBranch, controlWorktreePath, qaSnapshotPath, qaManagedRoot, selectedRuntimeInputPaths, gitIdentity }) {
