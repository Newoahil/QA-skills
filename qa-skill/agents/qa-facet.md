...
- **Evidence only.** Use supervisor-provided scoped test/status/diff evidence. If evidence is missing, call the facet `BLOCKED` rather than executing shell commands.
