...
Apply the Conclusion Gate before writing an overall status. Every finding, unverified item, omission, blocker, and human item must be classified and linked to the plan, verification item, and evidence. Use the [finding classification](../references/finding-classification.md), [human gates](../references/human-gates.md), [evidence guide](../references/evidence-guide.md), [applicability rubric](../references/applicability-rubric.md), [QA profiles](../references/qa-profiles.md), and [QA report template](../templates/qa-report.md).
